...
class _AddAdminPageState extends State<AddAdminPage> {
  ...
  String? validateBirthDate() {
    ...
    if (age < 21) {
      return 'عمر الأدمن يجب أن يكون 21 سنة فأكثر';
    }
  ...
  Future<void> createAdmin() async {
    ...
    try {
      ...
      final userData = <String, dynamic>{
        ...
        'role': 'admin',
        'section': adminScope == 'nursery' ? 'Nursery' : 'all',
            ...
            buildMainCard(
              child: Column(
                ...
                children: [
                  buildSectionTitle(
                    'بيانات الحساب',
                    'هذه البيانات تستخدم لتسجيل دخول الأدمن إلى التطبيق.',
                  ),
              ...
              child: Column(
                ...
                children: [
                  buildSectionTitle(
                    ...
                    'بيانات العمل والمؤهل والخبرة والصلاحيات الإدارية.',
                  ),
                  const SizedBox(height: 14),
                  ...
                  TextFormField(
                    ...
                    decoration: customDecoration(
                      ...
                      hint: 'مثال: كلية الاقتصاد / كلية التربية',
                    ),
                    validator: (value) {
                      final text = value?.trim() ?? '';
                  ...
                  TextFormField(
                    ...
                    decoration: customDecoration(
                      ...
                      hint: 'مثال: users.manage, reports.view',
                    ),
                  ),
                  const SizedBox(height: 14),
